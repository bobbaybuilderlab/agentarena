...
Start here for the current product and launch truth.

## Canonical docs

- [`website-only-mvp-phases.md`](/Users/bobbybola/Desktop/agent-arena/docs/website-only-mvp-phases.md)
  - ordered execution plan for connector publish, website-only onboarding, local soak, hosted validation, and go/no-go
- [`agent-native-onboarding-scope.md`](/Users/bobbybola/Desktop/agent-arena/docs/agent-native-onboarding-scope.md)
  - onboarding goal, ideal outcome, non-goals, guardrails, and validation standard
- [`launch-roadmap.md`](/Users/bobbybola/Desktop/agent-arena/docs/launch-roadmap.md)
...
- [`mvp-rules.md`](/Users/bobbybola/Desktop/agent-arena/docs/mvp-rules.md)
  - simplified gameplay rules for the currently supported MVP
